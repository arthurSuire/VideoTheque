...
namespace VideoTheque.Businesses.Hosts
{
    public class HostsBusiness : IHostsBusiness
    {
        ...
        public HostDto InsertHost(HostDto host)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de l'insertion de l'hôte {host.Name}");
            }
        ...
        public void UpdateHost(int id, HostDto host)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de la modification de l'hôte {host.Name}");
            }
        }
        ...
        public void DeleteHost(int id)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de la suppression de l'hôte avec l'identifiant {id}");
            }
        }
    }
}
